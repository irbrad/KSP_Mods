...
#pragma warning restore 0169
    ...
    [DllImport(Mpg123Dll)]
    public static extern int mpg123_param(IntPtr mh, mpg123_parms type, Int32 value, double fvalue);
    [DllImport(Mpg123Dll)]
    ...
    [DllImport(Mpg123Dll)]
    public static extern int mpg123_format_support(IntPtr mh, Int32 rate, int encoding);
    [DllImport(Mpg123Dll)]
    ...
    [DllImport(Mpg123Dll)]
    public static extern Int32 mpg123_clip(IntPtr mh);
    [DllImport(Mpg123Dll)]
    ...
    [DllImport(Mpg123Dll)]
    public static extern int mpg123_meta_check(IntPtr mh); /* On error (no valid handle) just 0 is returned. */
    [DllImport(Mpg123Dll)]
    public static extern int mpg123_id3(IntPtr mh, out IntPtr v1, out IntPtr v2);
    [DllImport(Mpg123Dll)]
    public static extern int mpg123_icy(IntPtr mh, IntPtr icy_meta); /* same for ICY meta string */
    [DllImport(Mpg123Dll)]
    ...
    [DllImport(Mpg123Dll)]
    public static extern int mpg123_fmt(IntPtr mh, Int32 rate, int channels, int encodings); /* 0 is good, -1 is error */
    [DllImport(Mpg123Dll)]
    public static extern int mpg123_fmt_support(IntPtr mh, Int32 rate, int encoding);
    [DllImport(Mpg123Dll)]
    public static extern int mpg123_par(IntPtr mp, mpg123_parms type, Int32 value, double fvalue);
    [DllImport(Mpg123Dll)]
